...
Windows test branch flow:

```powershell
git clone -b feat/windows-terminal-support https://github.com/getupyang/knowledge-base-extension.git
...
- Real Windows PowerShell / CMD execution.
- Claude Code and Codex CLI detection on a Windows machine.
- Chrome extension load-unpacked flow on Windows.
